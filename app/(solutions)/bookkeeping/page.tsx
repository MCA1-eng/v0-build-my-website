              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Providing first-class accounting services to meet your
                    financial needs. Our team of financial professionals is
                    dedicated to supporting small- and medium-sized businesses
                    with a wide range of accounting solutions tailored to fit
                    specific requirements. These services can help you minimize
                    tax liabilities, maximize earnings, and ensure your finances
