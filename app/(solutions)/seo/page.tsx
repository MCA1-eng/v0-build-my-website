              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Improve your business' visibility in search engine results.
                    SEO is a crucial part of your business' overall digital
                    strategy to ensure your website ranks higher when customers
                    search for your business or services online.
                  </p>
                </div>
            ...
            <div className="max-w-3xl mx-auto space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      Providing innovative web marketing solutions for small
                      businesses
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      ...
                      effectiveness to ultimately deliver real results
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Increasing search engine visibility</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Website design and on-page optimization</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Extensive web traffic reporting and tracking</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Content marketing and link acquisition</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Are you currently using any SEO service?</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Who is your target market?</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      If you do not have a website, we can help you get one put
                      up while ensuring that it will get maximum visibility
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      Increasing your visibility is the first step to increasing
                      your profits
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      ...
                      regardless of whether you are an eCommerce or non-commerce
                      site
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      We look at your target audience and your competition and
                      "reverse engineer" what search engines want to see
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      Experts estimate that Google is the primary method that
                      people under 30 use to find a new product or business
                    </span>
                  </div>
                </div>
              </div>
