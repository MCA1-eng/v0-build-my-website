              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    A fast funding option with affordable interest rates
                    enabling your business to replace, upgrade, or purchase the
                    equipment necessary to keep your venture operating smoothly.
                    Equipment financing can also serve as a type of asset-based
                    financing, where the equipment itself is used to back up or
                    secure the loan.
                  </p>
                </div>
            ...
            <div className="max-w-3xl mx-auto space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      A lien is placed on currently-owned equipment to obtain
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      A lien is placed on equipment you are planning to buy to
                      secure financing for its purchase.
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>The equipment’s age and condition</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>The equipment’s marketability (ease of resale)</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Your ability to repay the loan</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Do you have any valuable equipment?</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>What is the age and condition of the equipment?</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Are you looking to buy any valuable equipment?</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Is the equipment semi-liquid and market-ready?</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Year-to-date bank statements and financials</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Past two years of tax returns</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>Appraisal document for the equipment</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pl-14">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      Equipment financing can cover up to 100% of the
                      equipment’s value
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0" />
                    <span>
                      Use our tax calculator to estimate your savings,
